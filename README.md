...
Dublin Eats websites intends to allow  foodies of Dublin or tourists to discover new restaurants in Dublin according to what they are feeling for /craving for in the moment. Users will be able to search restaurants according to categories or cravings and rate/review the ones they have been to. Each Registered user has a profile page where they can also pin the restaurants they would like to visit in the future.Crud functionality is implemented in the way that users can create reviews for restaurants, read other users reviews , update their own reviews and delete their own reviews. Each user that visits the site can create an account which in essence creates a profile, read other user's profiles, edit their own profiles and delete their own profile. Superusers have access to other user's profiles and reviews in the front end to be able to delete them if needed.
...
Each Userstory had labels such as must-haves(necessity), should-haves(beneficial to have), could-haves(not important, nice to have). A MVP milestone was created for all the must-have labelled userstories. During development of website, most of the must-haves were implemented first to reach the MVP milestone(except README and TESTING). I did not allocate the time box for this as i was really unsure how long the development will take, as i did not have a set time schedule to work on my project due to the nature of my work schedule. My study times were not consistant , so i did not set a time for the milestone to be completed although i had a mental time duedate to get everything except README to be done 3 weeks before submission. This whole process of the agile planning was really difficult to implement due to their being a lack of guidance for this part of the project in the walk through videos, and with this being my first django website(I had searched slack and watched a lot of youtube videos, and did research outside of course material) i was not confident that i would be able to stick to a time due date for MVP. Next time i will implmenent time duedates for milestones as i have more of an idea as to how long a milestone could take.Each userstory was assigned story points too.Since this was the first time using story points and it was not really explained in the walk-through videos, it was challenging to identify which userstories to allocate more story points and how much story points to provide for each user story.Story points were allocated according to complexity or how time consuming the user story was.The should-have user story points did not exceed 60% of user story points total.
