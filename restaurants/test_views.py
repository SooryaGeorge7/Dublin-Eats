...
class TestRestaurantViews(TestCase):
    ...
    def test_add_restaurant_to_pinnedrestaurants(self):
        ...
        self.client.login(username="testuser", password="test123")
        response = self.client.get(reverse("to_visit", kwargs={"restaurant_id": self.restaurant.RestaurantId}))
        
        self.assertTrue(self.restaurant in self.profile.pinned_restaurants.all())
